...
<c:set var="inscripcionPagoCliente" scope = "session" value = "${param.inscripcionPagoCliente}"/>

<c:set var = "inscripcionVuelto" scope = "session" value = "${inscripcionPagoCliente-inscripcionPrecioFinal}"/>
...
<html>
    ...
    <center>
        <div class="container-fluid">
            ...
            <br>
            <b>Pago Cliente</b><br>
            $${inscripcionPagoCliente} <br>
            <br>
            <b>Vuelto</b><br>
            $<c:out value = "${inscripcionVuelto}"/>  <br>
            <br>
            <form action="/UTNAcademia/ServletRegistrarInscripcion" 
                  method="POST"
            ...
            <button type="button" 
                    ...
                    onclick="window.location.href = '/UTNAcademia/Inscripcion/Confirmacion1.jsp'">
                Volver
            </button>
            <br>
            <br>
