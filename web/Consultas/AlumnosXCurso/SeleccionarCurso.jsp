<%-- 
    ...
    Created on : 24-oct-2020, 20:16:19
    Author     : German
--%>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" 
                                                ...
                                                onclick="window.location.href = '/UTNAcademia/Consultas/AlumnosXCurso/Listado.jsp?cursoId=${arrayListCursos.cursoId}'">
                                            Seleccionar
                                        </button>
                                    </td>
                                    <td>
